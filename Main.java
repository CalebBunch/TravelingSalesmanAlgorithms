...
public class Main {
    ...
    public static void main(String[] args) {
        Graph graph = Algorithms.Helpers.generateGraph(9, MIN, MAX);
        ...
        Algorithms.Helpers.printPath(Algorithms.Optimization.simulatedAnnealing(path, 10));
        ...
        Algorithms.Helpers.printPath(Algorithms.Optimization.randomSwapping(path, 5));
    }
}
